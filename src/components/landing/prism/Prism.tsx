...
/* ================================================================== */
/*  Prism — adaptado de reactbits.dev/backgrounds/prism (registry      */
/*  @react-bits/Prism-JS-CSS). O shader e a matemática de rotação são  */
/*  os originais; o que mudou aqui é a tipagem em TS, a troca do       */
/*  Prism.css por classes utilitárias, o IntersectionObserver ligado   */
/*  por padrão (o canvas não gasta GPU fora da tela) e a parada limpa  */
/*  sob prefers-reduced-motion, que renderiza um único frame estático. */
/* ================================================================== */
...
export default function Prism({
  ...
  useEffect(() => {
    ...
    /* O prisma é raymarching: o custo é por pixel do buffer, não por
       elemento. Um celular reporta dpr 3 e o painel ocupa a tela toda,
       então 2x significava renderizar quatro vezes mais pixels do que
       1x a cada quadro. Abaixo de 640px o teto cai para 1.4 — a queda
       de nitidez some no desfoque do próprio shader. Desktop segue em 2. */
    const small =
    ...
    const hoverDriven = animationType === "hover" && !reduced;
    ...
    if (hoverDriven) {
      ...
      program.uniforms.uUseBaseWobble.value = reduced ? 0 : 1;
    }
    ...
    if (suspendWhenOffscreen && !reduced) {
